...
- [ ] Read out the passcode and the URL (genai-rt.web.app), and show the QR slide. 'One device per group creates; the others join with the six-character code it shows.'
